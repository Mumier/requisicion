...
class Customer extends CActiveRecord
{
	...
	{
		return array(
			'customer_id' => Yii::t('ShopModule.shop', 'Cliente'),
			'user_id' => Yii::t('ShopModule.shop', 'Usuario'),
			'address_id' => Yii::t('ShopModule.shop', 'Departamento'),
			'billing_address_id' => Yii::t('ShopModule.shop', 'Direccion de cobro'),
			'delivery_address_id' => Yii::t('ShopModule.shop', 'Direccion de entrega'),
